...
## Desarrollo
1.
Toma medidas para reducir tu uso de plástico. 2.
El facilitador introduce el concepto de las tres Rs (reducir, reutilizar, reemplazar). 3.
El facilitador presenta preguntas para iniciar una conversación sobre el plástico de un solo uso y alternativas.
