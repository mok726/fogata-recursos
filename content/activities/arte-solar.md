...
## Desarrollo
1. Preparación: Asegúrate de tener todos los materiales listos y un espacio seguro al aire libre.
2. Instrucciones:
- Enfoca la luz del Sol con una lupa sobre una tabla de madera para que ésta se marque.
- Puedes hacer un dibujo o escribir algo. Para facilitar, primero dibuja con un lápiz en la madera y luego repasa el dibujo con la luz del Sol focalizada por la lupa.
- Cuando termines, coloca las lupas en un lugar donde no estén expuestas a la luz solar.
3. Precauciones:
