...
## Desarrollo
1. Preparación: Imprime la plantilla del reloj de Sol o sigue las instrucciones para construirlo desde cero. 2. Instrucciones: - Coloca el reloj de Sol en un lugar donde reciba luz solar durante todo el día. - Marca la sombra cada hora para crear las líneas que indicarán la hora. 3. Discusión: - ¿Cómo cambia la sombra a lo largo del día? ¿Por qué creen que sucede esto?

## Cierre
- Reflexiona sobre cómo el Sol ha sido utilizado históricamente para medir el tiempo. - Pregunta: ¿Qué otras formas de medir el tiempo conocen?
